# Barbershop Product Spec — Phase 1 (Authoritative)

**Context:** 3 barbers, 1 shared POS machine, hybrid online + walk-in.  
**Supersedes:** Generic walk-in-only queue in early `engineering-modules.md` for barbershop vertical.  
**Features & pricing:** [`features-and-packages.md`](features-and-packages.md)
...
- **Quick barber switch:** tap avatar (Ali / Siti / Ben) → actions attributed to that barber (revenue, audit).
...
*Feeds: [`../design/ui-specification.md`](../design/ui-specification.md), [`engineering-modules.md`](engineering-modules.md).*
