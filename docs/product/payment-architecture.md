# Payment Architecture — HitPay Aggregator Model

**Status:** Draft — **pending co-founder approval**  
**Date:** June 2026  
**Related:** [`features-and-packages.md`](features-and-packages.md) · [`platform-architecture.md`](platform-architecture.md) · [`engineering-modules.md`](engineering-modules.md) (MOD-12) · [`../financial/ssot.md`](../financial/ssot.md)
...
**Tier gate:** HitPay rail on **Mantis+** only. Cash and merchant’s own DuitNow remain **exact subtotal, RM0** platform fee (manual confirm).
...
| R2 | Who initiates HitPay refund? | Owner PIN only · Manager | **Owner PIN only** (matches void in [`barbershop-spec.md`](barbershop-spec.md)) |
...
*After approval: sync [`platform-architecture.md`](platform-architecture.md) §4, [`engineering-modules.md`](engineering-modules.md) MOD-12, and [`../financial/ssot.md`](../financial/ssot.md) PAY assumptions.*
