# Platform Architecture — Universal Core vs Local Adapters

**Purpose:** How we scale worldwide without rebuilding POS for every country’s tax and labour rules.  
**Related:** [`features-and-packages.md`](features-and-packages.md) · [`barbershop-spec.md`](barbershop-spec.md)
...
**Mantis+ only** for HitPay rails. Ocelot uses cash + own DuitNow.

Full flow, automation, and scale: [`payment-architecture.md`](payment-architecture.md).
...
| **1B Mantis** | Receipt + tax export | POS shift + commission + payroll export | Same | **HitPay** QR + card |
...
| 2026-06-25 | **HitPay** — 2% customer surcharge; Mantis+; cash/own QR RM0 |
