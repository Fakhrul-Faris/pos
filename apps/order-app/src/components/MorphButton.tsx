  ...
  return (
    <div className={`relative ${fullWidth ? 'block w-full' : 'inline-block'}`}>
      ...
      <motion.button
        ...
        style={{ minWidth: fullWidth ? undefined : minWidth, scale, y, boxShadow }}
        className={`relative h-[52px] overflow-hidden rounded-xl px-8 text-base font-semibold disabled:cursor-wait ${fullWidth ? 'w-full' : ''} ${className}`}
      >
        <motion.span
